...
# Starotaku Web — Agent Guide

## What this is

A Next.js (App Router, TypeScript) client for browsing, searching, streaming, and tracking
anime/manga through the official MyAnimeList API v2. See `README.md` for the user-facing feature
list — this file is for agents working *in* the codebase.
